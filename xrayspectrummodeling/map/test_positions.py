...
class TestPositions(unittest.TestCase):
    ...
    def test_generate(self):
        ...
        positionsRef = [(-5.0e3, -5.0e3), (0.0e3, -5.0e3), (5.0e3, -5.0e3),
                        (-5.0e3, 0.0e3), (0.0e3, 0.0e3), (5.0e3, 0.0e3),
                        (-5.0e3, 5.0e3), (0.0e3, 5.0e3), (5.0e3, 5.0e3)]

        for positionRef, position in zip(positionsRef, positions):
    ...
    def test_get_array(self):
        ...
        positionsRef = np.array([(-5.0e3, -5.0e3), (0.0e3, -5.0e3), (5.0e3, -5.0e3),
                        (-5.0e3, 0.0e3), (0.0e3, 0.0e3), (5.0e3, 0.0e3),
                        (-5.0e3, 5.0e3), (0.0e3, 5.0e3), (5.0e3, 5.0e3)])

        shape = positionsRef.shape
        for i in range(shape[0]):
            for j in range(shape[1]):
                self.assertAlmostEqual(positionsRef[i ,j], positions[i, j], 2)
